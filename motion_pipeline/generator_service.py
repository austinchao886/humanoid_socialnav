...
from .artifact import convert_kimodo_qpos
...
from .protocol import GENERATE_TOPIC, STATUS_TOPIC, GenerateCommand, ProtocolError, State, status_json
        ...
        *,
        ...
        with tempfile.TemporaryDirectory(dir=self.exchange, prefix=".generating-") as temp:
            ...
            if source_npz.exists():
                ...
                from .artifact import render_artifact_preview
