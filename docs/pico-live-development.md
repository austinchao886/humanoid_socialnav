...
Long-hold follow-up: unchanged neutral and source frames 214/737 held 15 seconds each, evaluated at seconds 10–12 with a 3-second buffer before the next transition. Artifact pico-accuracy-longholds-v1 passes unchanged validator (3100 frames/62 s); exact plateaus verified. Five analysis tests pass, including explicit exclusion of later motion from hold evaluation. Harness supports selected conditions/repetitions while preserving isolation and safety preflight. No runtime, gain or model changes. Three fresh trials planned before interpreting bias.
