...
from video_generator.pipeline import OfflineVideoPipeline, VideoPipelineError, inspect_video
...
def test_offline_pipeline_exports_qpos_and_metadata(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("video_generator.pipeline.subprocess.run", _fake_run)
